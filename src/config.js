...
function ensureEnvFileWithMessaging() {
  ...
  if (!fs.existsSync(envPath)) {
    ...
    if (!content.includes("MAP_KEY=")) {
      ...
      console.log(`✔ Added MAP_KEY to existing .env`);
    } else {
...
function ensurePackageScripts() {
  ...
  if (changed) {
    ...
    console.log("✔ Updated package.json with Zozzona scripts");
  }
}
...
function installHusky() {
  ...
  // -----------------------------------------------------
  // 1. Create .huskyrc — REQUIRED FOR SHELL MODE IN V9
  // -----------------------------------------------------
  ...
  console.log("✔ Added .huskyrc (shell=true)");
...
`;
  ...
  console.log("✔ Added post-commit hook");
